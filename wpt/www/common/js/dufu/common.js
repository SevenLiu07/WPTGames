...
PLAY.staticUrl = http_type + "static." + getHost + "/";


//PLAY.webApiUrl = http_type + location.host + '/';
//PLAY.leaderBoardUrl = http_type + "webapps." + getHost + "/";
//PLAY.shopUrl = http_type + "shop." + getHost + "/";
PLAY.webApiUrl = http_type + "napi." + getHost + '/';
PLAY.leaderBoardUrl = http_type + "napi." + getHost + "/";
PLAY.shopUrl = http_type + "napi." + getHost + "/";
