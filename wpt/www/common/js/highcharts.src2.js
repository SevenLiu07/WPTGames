        ...
        H.Axis.prototype = {
            ...
            setAxisSize: function() {
               ...
               /* if(!$("#containerBg").length){
                    $("#container").append("<div id='containerBg'></div>");
                }
                $("#containerBg").css({
                    width:chart.chartWidth,
                    height:chart.chartHeight-109
                })*/
            },
    ...
    (function(H) {
        ...
        Chart.prototype = {
            ...
            getContainer: function() {
                ...
                /*设置背景样式*/
                chart.setContainerBgCss(chart.chartWidth,chart.chartHeight);

            },

           setContainerBgCss:function(chartWidth,chartHeight){
               if($(window).width() >= 480){
                  ...
                  /* if(parseInt(max)<100){
                   ...
                   }else if(parseInt(max) < 1000 && parseInt(max) >= 100){
                       $("#containerBg").css({
                           left:"53px"
                       });
                   }else if(parseInt(max) < 100000 && parseInt(max) >= 10000){
                       $("#containerBg").css({
                           left:"65px"
                       });
                   }else if(parseInt(max) < 1000000 && parseInt(max) >= 100000){
                       $("#containerBg").css({
                           left:"78px"
                       });
                   }else if(parseInt(max) < 10000000 && parseInt(max) >= 1000000){
                       $("#containerBg").css({
                           left:"90px"
                       });
                   }else if(parseInt(max) < 100000000 && parseInt(max) >= 10000000){
                       $("#containerBg").css({
                           left:"100px"
                       });
                   }
                   setTimeout(function(){
                       var val = $(".highcharts-yaxis-labels").find("span:last").text();
                       if(val.indexOf(".5") !== -1){
                           $("#containerBg").css({
                               left:"56px"
                           });
                   ...
                   $("#container").css("background"," #162468");
                   $("#containerBg").css({
                       left:"0"
                   });
               }
            ...
            setChartSize: function(skipAxes) {
                ...
                //chart.plotHeight =  chart.plotHeight+30
